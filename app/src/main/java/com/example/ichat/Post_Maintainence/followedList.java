...
public class followedList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.following_followed_recyclerview2);
        searchUsers = findViewById(R.id.searchFollowedUsers);
        ...
        adapter = new followingAdapter(this, list,followedList.this);
        ...
        if (list != null) {
            reference.child("Followed").child(receiverUid).addValueEventListener(new ValueEventListener() {
                @Override
